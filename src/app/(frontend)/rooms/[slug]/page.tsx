            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {isSoldOut && (
                    <span className="bg-destructive/10 text-destructive border border-destructive/20 px-3 py-1 text-xs uppercase font-bold tracking-widest rounded-sm">
                      Hết phòng
                    </span>
                  )}
                </div>
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 h-fit space-y-6">
            <div className="bg-white border border-border shadow-xl p-8 rounded-none">
              ...
              {isSoldOut ? (
                <button
                  disabled
                  className="block w-full text-center bg-muted text-muted-foreground py-4 font-medium cursor-not-allowed mb-4"
                >
                  Đã hết phòng
                </button>
              ) : (
